...
function loadAll(payload) {
	...
	if (payload.companysrc)
		img.html("<img src='" + PREFIX + payload.companysrc + "' class='modal-img' alt='" + payload.title +"'><br><br>");
	else if (payload.doublesrc)
		img.html("<img src='" + PREFIX + "assets/team/bae.jpg' class='modal-img-small super-rounded' alt='Benigna Ahsan'>" +
			"<img src='" + PREFIX + "assets/team/j_l.jpg' class='modal-img-small super-rounded' alt='Jamie-Lee Freeston'>");
	else if (payload.speakersrc)
		img.html("<img src='" + PREFIX + payload.speakersrc + "' class='modal-img rounded' alt='" + payload.title +"'>");
